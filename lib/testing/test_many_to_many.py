...
def test_contract_contracts_by_date():
    ...
    expected_sorted_contracts = [contract2, contract4]
    assert sorted_contracts == expected_sorted_contracts, f"Expected {expected_sorted_contracts}, but got {sorted_contracts}"
